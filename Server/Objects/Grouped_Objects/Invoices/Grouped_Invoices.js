const parameters = require('./CRUD_parameters');
      global.GroupedCrudsInvoices_object = {
        versions: {
          versionData: [
            {
              "*": {
                      ...
                      apiInfo: {
                        query: {
                          ...
                          queryPayload: {
                            ...
                            View: "SELECT invoices.invoice_id as invoices_id, invoices.invoice_id as invoices_invoiceId, invoices.user_id as invoices_userId, invoices.amount as invoices_amount, invoices.status as invoices_status, invoices.updated_by as invoices_updatedBy, invoices.updated_at as invoices_updatedAt, invoices.created_at as invoices_createdAt, users.user_id as users_id, users.user_id as users_userId, users.email as users_email, users.status as users_status, users.phone_no as users_phoneNo, users.status as users_status, users.cnic as users_cnic, users.status as users_status, users.email as users_email, users.status as users_status, users.phone_no as users_phoneNo, users.status as users_status, users.cnic as users_cnic, users.status as users_status, users.first_name as users_firstName, users.last_name as users_lastName, users.gender as users_gender, users.father_name as users_fatherName, users.image_attachment_id as users_imageAttachmentId, users.address as users_address, users.date_of_birth as users_dateOfBirth, users.blood_group as users_bloodGroup, users.religion as users_religion, users.updated_by as users_updatedBy, users.created_at as users_createdAt, users.updated_at as users_updatedAt FROM invoices JOIN users ON users.user_id = invoices.user_id WHERE invoices.invoice_id = {{id}} OR invoices.invoice_id IS NULL",

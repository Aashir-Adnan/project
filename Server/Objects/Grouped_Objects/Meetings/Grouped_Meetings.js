const parameters = require('./CRUD_parameters');
      global.GroupedCrudsMeetings_object = {
        versions: {
          versionData: [
            {
              "*": {
                      ...
                      apiInfo: {
                        query: {
                          ...
                          queryPayload: {
                            ...
                            View: "SELECT meetings.meeting_id as meetings_id, meetings.meeting_id as meetings_meetingId, meetings.created_by as meetings_createdBy, meetings.start_time as meetings_startTime, meetings.end_time as meetings_endTime, meetings.status as meetings_status, meetings.updated_by as meetings_updatedBy, meetings.updated_at as meetings_updatedAt, meetings.created_at as meetings_createdAt, users.user_id as users_id, users.user_id as users_userId, users.email as users_email, users.status as users_status, users.phone_no as users_phoneNo, users.status as users_status, users.cnic as users_cnic, users.status as users_status, users.email as users_email, users.status as users_status, users.phone_no as users_phoneNo, users.status as users_status, users.cnic as users_cnic, users.status as users_status, users.first_name as users_firstName, users.last_name as users_lastName, users.gender as users_gender, users.father_name as users_fatherName, users.image_attachment_id as users_imageAttachmentId, users.address as users_address, users.date_of_birth as users_dateOfBirth, users.blood_group as users_bloodGroup, users.religion as users_religion, users.updated_by as users_updatedBy, users.created_at as users_createdAt, users.updated_at as users_updatedAt FROM meetings JOIN users ON users.user_id = meetings.created_by WHERE meetings.meeting_id = {{id}} OR meetings.meeting_id IS NULL",
                      ...
                      apiInfo: {
                        query: {
                          ...
                          queryPayload: {
                            ...
                            View: "SELECT meetings.meeting_id as meetings_id, meetings.meeting_id as meetings_meetingId, meetings.created_by as meetings_createdBy, meetings.start_time as meetings_startTime, meetings.end_time as meetings_endTime, meetings.status as meetings_status, meetings.updated_by as meetings_updatedBy, meetings.updated_at as meetings_updatedAt, meetings.created_at as meetings_createdAt, users.user_id as users_id, users.user_id as users_userId, users.email as users_email, users.status as users_status, users.phone_no as users_phoneNo, users.status as users_status, users.cnic as users_cnic, users.status as users_status, users.email as users_email, users.status as users_status, users.phone_no as users_phoneNo, users.status as users_status, users.cnic as users_cnic, users.status as users_status, users.first_name as users_firstName, users.last_name as users_lastName, users.gender as users_gender, users.father_name as users_fatherName, users.image_attachment_id as users_imageAttachmentId, users.address as users_address, users.date_of_birth as users_dateOfBirth, users.blood_group as users_bloodGroup, users.religion as users_religion, users.updated_by as users_updatedBy, users.created_at as users_createdAt, users.updated_at as users_updatedAt FROM meetings JOIN users ON users.user_id = meetings.created_by WHERE meetings.meeting_id = {{id}} OR meetings.user_id IS NULL",

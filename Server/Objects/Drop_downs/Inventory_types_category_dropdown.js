global.Inventory_types_categoryDropdown_object = {
      versions: {
        versionData: [
          {
            "*": {
              steps: [
                {
                  ...
                  data: {
                    ...
                    apiInfo: {
                      query: {
                        "queryNature": "SELECT",
                        "queryPayload": "SELECT category_name as label, inventory_types_category_id as value FROM inventory_types_category", 

global.Inventory_sub_category_itemsDropdown_object = {
      versions: {
        versionData: [
          {
            "*": {
              steps: [
                {
                  ...
                  data: {
                    ...
                    apiInfo: {
                      query: {
                        "queryNature": "SELECT",
                        "queryPayload": "SELECT inventory_sub_category_item_name as label, inventory_sub_category_item_id as value FROM inventory_sub_category_items", 
                    ...
                    requestMetaData: {
                      requestMethod: "GET",
                      permission: [
                        "list_inventory_sub_category_items"
                      ],

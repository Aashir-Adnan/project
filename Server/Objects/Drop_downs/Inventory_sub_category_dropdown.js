global.Inventory_sub_categoryDropdown_object = {
      versions: {
        versionData: [
          {
            "*": {
              steps: [
                {
                  ...
                  data: {
                    ...
                    apiInfo: {
                      query: {
                        "queryNature": "SELECT",
                        "queryPayload": "SELECT sub_category_items_name as label, inventory_sub_category_id as value FROM inventory_sub_category", 

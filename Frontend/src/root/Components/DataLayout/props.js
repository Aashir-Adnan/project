...
export const data = {
  features: {
    ...
    list: {
      ...
      //   data: [
      //     {
      //       ComponentID:1,   //it must be initialized as it is for the table rendering but must be unique value
      //       name: "Usama Bin Shakeel",
      //       role: "Supervisor",
      //       designation: "Teacher",
      //       email: "ubs@itu.edu.pk",
      //       description: "Supervisor for FYP on the University management system ",
      //       image: "https://www.w3schools.com/images/w3schools_green.jpg",
      //     },
      //     {
      //       ComponentID:2,  //it must be initialized as it is for the table rendering but must be unique value
      //       name: "Sarfraz Raza",
      //       role: "Co Supervisor",
      //       designation: "Teacher",
      //       email: "sarfraz.raza@itu.edu.pk",
      //       description: "Co-Supervisor for FYP on the  University management system",
      //       image: "https://www.w3schools.com/images/w3schools_green.jpg",
      //     },
      //     {
      //       ComponentID:3,  //it must be initialized as it is for the table rendering but must be unique value
      //       name: "Afaq Khawar",
      //       role: "Developer",
      //       designation: "Student",
      ...
      //     },
      //     {
      //       ComponentID:4,  //it must be initialized as it is for the table rendering but must be unique value
      ...
      //     {
      //       ComponentID:5,  //it must be initialized as it is for the table rendering but must be unique value
      //       name: "Awais Fayyaz",
      //       role: "Stakeholder",
      ...
      //     },
      //     {
      //       ComponentID:6,  //it must be initialized as it is for the table rendering but must be unique value
      //       name: "Usman Saleem ",
      //       role: "Stakeholder",

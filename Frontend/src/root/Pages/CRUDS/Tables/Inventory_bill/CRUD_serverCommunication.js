        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_inventory_bill',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/inventory_bill?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_inventory_bill',
                    ...
                    name: "View",
                    color: "grey",
                    permission: 'view_inventory_bill',
                ...
                export: {
                  permission: 'export_inventory_bill',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_inventory_bill',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "inventory_bill_inventoryBillId", "inventory_bill_inventoryVendorId", "inventory_bill_billSerialNumber", "inventory_bill_companyName", "inventory_bill_billAmount", "inventory_bill_status", "inventory_bill_updatedBy", "inventory_bill_updatedAt", "inventory_bill_createdAt"
                    ],
                ...
                sort: {
                permission: 'sort_inventory_bill',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_inventory_bill',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/inventory_bill?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_inventory_bill',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/inventory_bill/view",
                      apiActionType: "hr_inventory_bill_view",
                      requestType: "GET",
                      reduxActionType: "hr_inventory_bill_view",
                  }),
                  options: {
                      pageSize: 10,

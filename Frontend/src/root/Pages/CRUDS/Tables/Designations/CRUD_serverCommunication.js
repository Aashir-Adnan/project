              ...
              features: {
                  ...
                  actions: [
                      ...
                      form: generateFormProps({
                          parameters: parameters,
                          apiUrl: "/designations/update?version=1.0",
                          requestType: "PUT",
                          mode:"edit"
                      }),
                      },
                      ...
                      serverCommunication: serverCommunicationHelper({
                          parameters: parameters,
                          apiUrl:"/designations/delete?version=1.0",
                          requestType: "DELETE",
                      }),
                      ...
                      form: generateFormProps({
                          parameters: parameters,
                          apiUrl: "/designations/view?version=1.0",
                          requestType: "GET",
                          mode:"view"
                      }),
                      },
                  ...
                  add: {
                      ...
                      form: generateFormProps({
                      parameters: parameters,
                      apiUrl: "/designations/add?version=1.0",
                      requestType: "POST",
                      mode:"create"
                      }),
                  },
                  ...
                  options: {
                      filterBy: [
                          "designations_designationId", "designations_designationName", "designations_status", "designations_designationName", "designations_status", "designations_seniorDesignationId", "designations_seniorDesignationId", "designations_updatedBy", "designations_createdAt", "designations_updatedAt"
                      ],
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl:  "/designations/list?version=1.0",
                      apiActionType: "",
                      requestType: "GET",
                      reduxActionType: "",
                  }),
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/designations/view",
                      apiActionType: "hr_designations_view",
                      requestType: "GET",
                      reduxActionType: "hr_designations_view",
                  }),
                  options: {
                      pageSize: 10,

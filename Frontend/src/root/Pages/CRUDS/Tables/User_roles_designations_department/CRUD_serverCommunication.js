            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/user_roles_designations_department?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "user_roles_designations_department_userRoleDesignationDepartmentId", "user_roles_designations_department_roleDesignationDepartmentId", "user_roles_designations_department_userId", "user_roles_designations_department_status", "user_roles_designations_department_roleDesignationDepartmentId", "user_roles_designations_department_userId", "user_roles_designations_department_status", "user_roles_designations_department_startDate", "user_roles_designations_department_endDate", "user_roles_designations_department_updatedBy", "user_roles_designations_department_createdAt", "user_roles_designations_department_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/user_roles_designations_department/view",
                      apiActionType: "hr_user_roles_designations_department_view",
                      requestType: "GET",
                      reduxActionType: "hr_user_roles_designations_department_view",
                  }),
                  options: {
                      pageSize: 10,

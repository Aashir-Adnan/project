        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_campus',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/campus?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "campus_campusId", "campus_campusName", "campus_campusLocation", "campus_status", "campus_updatedBy", "campus_updatedAt", "campus_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/campus/view",
                      apiActionType: "hr_campus_view",
                      requestType: "GET",
                      reduxActionType: "hr_campus_view",
                  }),
                  options: {
                      pageSize: 10,

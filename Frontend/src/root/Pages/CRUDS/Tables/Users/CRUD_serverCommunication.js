import { parameters } from "./CRUD_parameters.js";
        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                options: {
                    filterBy: [
                        "users_userId", "users_email", "users_status", "users_phoneNo", "users_status", "users_cnic", "users_status", "users_email", "users_status", "users_phoneNo", "users_status", "users_cnic", "users_status", "users_firstName", "users_lastName", "users_gender", "users_fatherName", "users_imageAttachmentId", "users_address", "users_dateOfBirth", "users_bloodGroup", "users_religion", "users_updatedBy", "users_createdAt", "users_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/users/view",
                      apiActionType: "hr_users_view",
                      requestType: "GET",
                      reduxActionType: "hr_users_view",
                  }),
                  options: {
                      pageSize: 10,

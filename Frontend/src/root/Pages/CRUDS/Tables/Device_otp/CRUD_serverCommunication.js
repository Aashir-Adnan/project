            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/device_otp?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "device_otp_userDeviceId", "device_otp_otp", "device_otp_status", "device_otp_deviceOtpId", "device_otp_otpFailureCount", "device_otp_updatedBy", "device_otp_updatedAt", "device_otp_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/device_otp/view",
                      apiActionType: "hr_device_otp_view",
                      requestType: "GET",
                      reduxActionType: "hr_device_otp_view",
                  }),
                  options: {
                      pageSize: 10,

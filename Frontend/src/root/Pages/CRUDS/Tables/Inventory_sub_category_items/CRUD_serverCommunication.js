        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_inventory_sub_category_items',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/inventory_sub_category_items?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_inventory_sub_category_items',
                    ...
                    name: "View",
                    color: "grey",
                    permission: 'view_inventory_sub_category_items',
                ...
                bulkAction: {
                add: {
                    permission:'add_inventory_sub_category_items',
                    form: generateFormProps({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/inventory_sub_category_items?version=1.0",
                    requestType: "POST",
                ...
                export: {
                  permission: 'export_inventory_sub_category_items',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_inventory_sub_category_items',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "inventory_sub_category_items_inventorySubCategoryItemId", "inventory_sub_category_items_inventorySubCategoryId", "inventory_sub_category_items_parentInventorySubCategoryItemId", "inventory_sub_category_items_itemLocationId", "inventory_sub_category_items_inventoryBillId", "inventory_sub_category_items_inventorySubCategoryItemName", "inventory_sub_category_items_companyName", "inventory_sub_category_items_status", "inventory_sub_category_items_updatedBy", "inventory_sub_category_items_updatedAt", "inventory_sub_category_items_createdAt"
                    ],
                ...
                sort: {
                permission: 'sort_inventory_sub_category_items',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_inventory_sub_category_items',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/inventory_sub_category_items?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_inventory_sub_category_items',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/inventory_sub_category_items/view",
                      apiActionType: "hr_inventory_sub_category_items_view",
                      requestType: "GET",
                      reduxActionType: "hr_inventory_sub_category_items_view",
                  }),
                  options: {
                      pageSize: 10,

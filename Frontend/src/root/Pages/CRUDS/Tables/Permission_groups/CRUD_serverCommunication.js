            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/permission_groups?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "permission_groups_permissionGroupId", "permission_groups_groupName", "permission_groups_status", "permission_groups_groupName", "permission_groups_status", "permission_groups_updatedBy", "permission_groups_createdAt", "permission_groups_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/permission_groups/view",
                      apiActionType: "hr_permission_groups_view",
                      requestType: "GET",
                      reduxActionType: "hr_permission_groups_view",
                  }),
                  options: {
                      pageSize: 10,

            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/permissions?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "permissions_permissionId", "permissions_permissionName", "permissions_status", "permissions_permissionName", "permissions_status", "permissions_updatedBy", "permissions_createdAt", "permissions_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/permissions/view",
                      apiActionType: "hr_permissions_view",
                      requestType: "GET",
                      reduxActionType: "hr_permissions_view",
                  }),
                  options: {
                      pageSize: 10,

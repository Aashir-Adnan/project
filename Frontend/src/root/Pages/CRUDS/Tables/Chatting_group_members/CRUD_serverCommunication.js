        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_chatting_group_members',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/chatting_group_members?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_chatting_group_members',
                    ...
                    name: "View",
                    color: "grey",
                    permission: 'view_chatting_group_members',
                ...
                bulkAction: {
                add: {
                    permission:'add_chatting_group_members',
                    form: generateFormProps({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/chatting_group_members?version=1.0",
                    requestType: "POST",
                ...
                export: {
                  permission: 'export_chatting_group_members',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_chatting_group_members',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "chatting_group_members_chattingGroupMemberId", "chatting_group_members_chattingGroupId", "chatting_group_members_userRoleDesignationDepartmentId", "chatting_group_members_chattingGroupPermissionId", "chatting_group_members_status", "chatting_group_members_updatedBy", "chatting_group_members_createdAt", "chatting_group_members_updatedAt"
                    ],
                ...
                sort: {
                permission: 'sort_chatting_group_members',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_chatting_group_members',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/chatting_group_members?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_chatting_group_members',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/chatting_group_members/view",
                      apiActionType: "hr_chatting_group_members_view",
                      requestType: "GET",
                      reduxActionType: "hr_chatting_group_members_view",
                  }),
                  options: {
                      pageSize: 10,

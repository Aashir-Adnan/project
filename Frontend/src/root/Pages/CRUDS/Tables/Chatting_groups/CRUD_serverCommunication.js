        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_chatting_groups',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/chatting_groups?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_chatting_groups',
                    ...
                    name: "View",
                    color: "grey",
                    permission: 'view_chatting_groups',
                ...
                bulkAction: {
                add: {
                    permission:'add_chatting_groups',
                    form: generateFormProps({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/chatting_groups?version=1.0",
                    requestType: "POST",
                ...
                export: {
                  permission: 'export_chatting_groups',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_chatting_groups',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "chatting_groups_chattingGroupId", "chatting_groups_chattingGroupName", "chatting_groups_status", "chatting_groups_chattingGroupName", "chatting_groups_status", "chatting_groups_updatedBy", "chatting_groups_updatedAt", "chatting_groups_createdAt"
                    ],
                ...
                sort: {
                permission: 'sort_chatting_groups',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_chatting_groups',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/chatting_groups?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_chatting_groups',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/chatting_groups/view",
                      apiActionType: "hr_chatting_groups_view",
                      requestType: "GET",
                      reduxActionType: "hr_chatting_groups_view",
                  }),
                  options: {
                      pageSize: 10,

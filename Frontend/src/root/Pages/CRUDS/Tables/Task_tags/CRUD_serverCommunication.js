        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_task_tags',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/task_tags?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "task_tags_tagId", "task_tags_taskId", "task_tags_tag", "task_tags_status", "task_tags_updatedBy", "task_tags_updatedAt", "task_tags_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/task_tags/view",
                      apiActionType: "hr_task_tags_view",
                      requestType: "GET",
                      reduxActionType: "hr_task_tags_view",
                  }),
                  options: {
                      pageSize: 10,

        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_inventory_sub_category',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/inventory_sub_category?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_inventory_sub_category',
                    ...
                    name: "View",
                    color: "grey",
                    permission: 'view_inventory_sub_category',
                ...
                bulkAction: {
                add: {
                    permission:'add_inventory_sub_category',
                    form: generateFormProps({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/inventory_sub_category?version=1.0",
                    requestType: "POST",
                ...
                export: {
                  permission: 'export_inventory_sub_category',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_inventory_sub_category',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "inventory_sub_category_inventorySubCategoryId", "inventory_sub_category_inventoryTypesCategoryId", "inventory_sub_category_attributeGroupsAttributeId", "inventory_sub_category_subCategoryItemsName", "inventory_sub_category_status", "inventory_sub_category_updatedBy", "inventory_sub_category_updatedAt", "inventory_sub_category_createdAt"
                    ],
                ...
                sort: {
                permission: 'sort_inventory_sub_category',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_inventory_sub_category',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/inventory_sub_category?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_inventory_sub_category',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/inventory_sub_category/view",
                      apiActionType: "hr_inventory_sub_category_view",
                      requestType: "GET",
                      reduxActionType: "hr_inventory_sub_category_view",
                  }),
                  options: {
                      pageSize: 10,

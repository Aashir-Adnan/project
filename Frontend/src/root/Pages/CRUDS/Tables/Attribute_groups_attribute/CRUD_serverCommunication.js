        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_attribute_groups_attribute',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/attribute_groups_attribute?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_attribute_groups_attribute',
                    ...
                    name: "View",
                    color: "grey",
                    permission: 'view_attribute_groups_attribute',
                ...
                bulkAction: {
                add: {
                    permission:'add_attribute_groups_attribute',
                    form: generateFormProps({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/attribute_groups_attribute?version=1.0",
                    requestType: "POST",
                ...
                export: {
                  permission: 'export_attribute_groups_attribute',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_attribute_groups_attribute',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "attribute_groups_attribute_attributeGroupsAttributeId", "attribute_groups_attribute_attributesId", "attribute_groups_attribute_attributesGroupsId", "attribute_groups_attribute_status", "attribute_groups_attribute_updatedBy", "attribute_groups_attribute_updatedAt", "attribute_groups_attribute_createdAt"
                    ],
                ...
                sort: {
                permission: 'sort_attribute_groups_attribute',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_attribute_groups_attribute',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/attribute_groups_attribute?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_attribute_groups_attribute',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/attribute_groups_attribute/view",
                      apiActionType: "hr_attribute_groups_attribute_view",
                      requestType: "GET",
                      reduxActionType: "hr_attribute_groups_attribute_view",
                  }),
                  options: {
                      pageSize: 10,

        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_item_maintenance',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/item_maintenance?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_item_maintenance',
                    ...
                    name: "View",
                    color: "grey",
                    permission: 'view_item_maintenance',
                ...
                bulkAction: {
                add: {
                    permission:'add_item_maintenance',
                    form: generateFormProps({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/item_maintenance?version=1.0",
                    requestType: "POST",
                ...
                export: {
                  permission: 'export_item_maintenance',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_item_maintenance',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "item_maintenance_itemMaintenanceId", "item_maintenance_taskId", "item_maintenance_inventorySubCategoryItemId", "item_maintenance_userRoleDesignationDepartmentId", "item_maintenance_inventoryBillId", "item_maintenance_description", "item_maintenance_maintenanceDate", "item_maintenance_status", "item_maintenance_updatedBy", "item_maintenance_updatedAt", "item_maintenance_createdAt"
                    ],
                ...
                sort: {
                permission: 'sort_item_maintenance',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_item_maintenance',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/item_maintenance?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_item_maintenance',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/item_maintenance/view",
                      apiActionType: "hr_item_maintenance_view",
                      requestType: "GET",
                      reduxActionType: "hr_item_maintenance_view",
                  }),
                  options: {
                      pageSize: 10,

            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/files?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "files_fileId", "files_taskId", "files_projectId", "files_uploadedBy", "files_fileName", "files_fileUrl", "files_fileSize", "files_status", "files_updatedBy", "files_updatedAt", "files_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/files/view",
                      apiActionType: "hr_files_view",
                      requestType: "GET",
                      reduxActionType: "hr_files_view",
                  }),
                  options: {
                      pageSize: 10,

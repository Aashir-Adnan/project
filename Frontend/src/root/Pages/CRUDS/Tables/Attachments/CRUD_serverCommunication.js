import { parameters } from "./CRUD_parameters.js";
        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                options: {
                    filterBy: [
                        "attachments_attachmentId", "attachments_attachmentName", "attachments_status", "attachments_attachmentName", "attachments_status", "attachments_uploadedByUserRoleDesignationDepartmentId", "attachments_attachmentType", "attachments_attachmentSize", "attachments_attachmentLink", "attachments_updatedBy", "attachments_createdAt", "attachments_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/attachments/view",
                      apiActionType: "hr_attachments_view",
                      requestType: "GET",
                      reduxActionType: "hr_attachments_view",
                  }),
                  options: {
                      pageSize: 10,

            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/invoices?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "invoices_invoiceId", "invoices_userId", "invoices_amount", "invoices_status", "invoices_updatedBy", "invoices_updatedAt", "invoices_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/invoices/view",
                      apiActionType: "hr_invoices_view",
                      requestType: "GET",
                      reduxActionType: "hr_invoices_view",
                  }),
                  options: {
                      pageSize: 10,

        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_user_role_designation_permissions',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/user_role_designation_permissions?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_user_role_designation_permissions',
                ...
                bulkAction: {
                add: {
                    permission:'add_user_role_designation_permissions',
                    form: generateFormProps({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/user_role_designation_permissions?version=1.0",
                    requestType: "POST",
                ...
                export: {
                  permission: 'export_user_role_designation_permissions',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_user_role_designation_permissions',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "user_role_designation_permissions_userRoleDesignationPermissionId", "user_role_designation_permissions_userRoleDesignationDepartmentId", "user_role_designation_permissions_permissionId", "user_role_designation_permissions_status", "user_role_designation_permissions_userRoleDesignationDepartmentId", "user_role_designation_permissions_permissionId", "user_role_designation_permissions_status", "user_role_designation_permissions_updatedBy", "user_role_designation_permissions_updatedAt", "user_role_designation_permissions_createdAt"
                    ],
                ...
                sort: {
                permission: 'sort_user_role_designation_permissions',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_user_role_designation_permissions',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/user_role_designation_permissions?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_user_role_designation_permissions',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/user_role_designation_permissions/view",
                      apiActionType: "hr_user_role_designation_permissions_view",
                      requestType: "GET",
                      reduxActionType: "hr_user_role_designation_permissions_view",
                  }),
                  options: {
                      pageSize: 10,

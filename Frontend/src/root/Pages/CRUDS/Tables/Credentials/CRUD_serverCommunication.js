            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/credentials?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "credentials_credentialsId", "credentials_credentialsInfo", "credentials_inventorySubCategoryItemId", "credentials_userRoleDesignationDepartmentId", "credentials_status", "credentials_updatedBy", "credentials_updatedAt", "credentials_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/credentials/view",
                      apiActionType: "hr_credentials_view",
                      requestType: "GET",
                      reduxActionType: "hr_credentials_view",
                  }),
                  options: {
                      pageSize: 10,

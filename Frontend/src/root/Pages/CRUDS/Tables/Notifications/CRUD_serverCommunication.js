            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/notifications?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "notifications_notificationId", "notifications_notificationTitle", "notifications_status", "notifications_notificationTitle", "notifications_status", "notifications_notificationMessage", "notifications_sentToUserRoleDesignationDepartmentId", "notifications_updatedBy", "notifications_updatedAt", "notifications_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/notifications/view",
                      apiActionType: "hr_notifications_view",
                      requestType: "GET",
                      reduxActionType: "hr_notifications_view",
                  }),
                  options: {
                      pageSize: 10,

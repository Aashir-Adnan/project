            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/user_device_notifications?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "user_device_notifications_userDeviceNotificationId", "user_device_notifications_userDeviceId", "user_device_notifications_notificationId", "user_device_notifications_status", "user_device_notifications_updatedBy", "user_device_notifications_updatedAt", "user_device_notifications_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/user_device_notifications/view",
                      apiActionType: "hr_user_device_notifications_view",
                      requestType: "GET",
                      reduxActionType: "hr_user_device_notifications_view",
                  }),
                  options: {
                      pageSize: 10,

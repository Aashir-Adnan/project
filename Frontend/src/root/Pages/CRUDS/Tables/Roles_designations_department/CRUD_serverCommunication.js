            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/roles_designations_department?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "roles_designations_department_roleDesignationDepartmentId", "roles_designations_department_designationId", "roles_designations_department_roleId", "roles_designations_department_departmentId", "roles_designations_department_status", "roles_designations_department_designationId", "roles_designations_department_roleId", "roles_designations_department_departmentId", "roles_designations_department_status", "roles_designations_department_updatedBy", "roles_designations_department_createdAt", "roles_designations_department_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/roles_designations_department/view",
                      apiActionType: "hr_roles_designations_department_view",
                      requestType: "GET",
                      reduxActionType: "hr_roles_designations_department_view",
                  }),
                  options: {
                      pageSize: 10,

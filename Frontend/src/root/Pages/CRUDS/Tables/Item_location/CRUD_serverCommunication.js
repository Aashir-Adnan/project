        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_item_location',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/item_location?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_item_location',
                ...
                export: {
                  permission: 'export_item_location',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_item_location',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "item_location_itemLocationId", "item_location_inventorySubCategoryItemId", "item_location_locationName", "item_location_departureDate", "item_location_arrivalDate", "item_location_placedByUserRoleDesignationDepartmentId", "item_location_displacedByUserRoleDesignationDepartmentId", "item_location_status", "item_location_updatedBy", "item_location_updatedAt", "item_location_createdAt"
                    ],
                ...
                search: {
                permission: 'search_item_location',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/item_location/view",
                      apiActionType: "hr_item_location_view",
                      requestType: "GET",
                      reduxActionType: "hr_item_location_view",
                  }),
                  options: {
                      pageSize: 10,

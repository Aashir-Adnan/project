            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/platforms?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "platforms_platformId", "platforms_platformName", "platforms_status", "platforms_platformName", "platforms_status", "platforms_updatedBy", "platforms_createdAt", "platforms_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/platforms/view",
                      apiActionType: "hr_platforms_view",
                      requestType: "GET",
                      reduxActionType: "hr_platforms_view",
                  }),
                  options: {
                      pageSize: 10,

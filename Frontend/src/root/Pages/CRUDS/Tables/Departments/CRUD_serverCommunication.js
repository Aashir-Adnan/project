            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/departments?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "departments_departmentId", "departments_departmentName", "departments_status", "departments_departmentName", "departments_status", "departments_updatedBy", "departments_createdAt", "departments_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      ...
                      apiActionType: "hr_departments_view",
                      requestType: "GET",
                      reduxActionType: "hr_departments_view",
                  }),
                  options: {
                      pageSize: 10,

        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_alter_table_errors',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/alter_table_errors?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_alter_table_errors',
                    ...
                    name: "View",
                    color: "grey",
                    permission: 'view_alter_table_errors',
                ...
                bulkAction: {
                add: {
                    permission:'add_alter_table_errors',
                    form: generateFormProps({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/alter_table_errors?version=1.0",
                    requestType: "POST",
                ...
                export: {
                  permission: 'export_alter_table_errors',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_alter_table_errors',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "alter_table_errors_id", "alter_table_errors_tableName", "alter_table_errors_errorMessage", "alter_table_errors_errorTime", "alter_table_errors_createdBy"
                    ],
                ...
                sort: {
                permission: 'sort_alter_table_errors',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                list: {
                permission:'list_alter_table_errors',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "/grouped/cruds/alter_table_errors?version=1.0",
                    apiActionType: "",
                ...
                search: {
                permission: 'search_alter_table_errors',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/alter_table_errors/view",
                      apiActionType: "hr_alter_table_errors_view",
                      requestType: "GET",
                      reduxActionType: "hr_alter_table_errors_view",
                  }),
                  options: {
                      pageSize: 10,

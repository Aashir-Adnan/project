        ...
        export const listing_crud_props = {
            ...
            features: {
                ...
                actions: [
                    ...
                    name: "Edit",
                    color: "blue",
                    permission: 'update_time_tracking',
                    onAction: () => console.log("Button pressed Edit"),
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/time_tracking?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                    ...
                    name: "Delete",
                    color: "red",
                    permission: 'delete_time_tracking',
                ...
                export: {
                  permission: 'export_time_tracking',
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "",
                      apiActionType: "",
                ...
                filter: {
                permission: 'filter_time_tracking',
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                    apiActionType: "",
                ...
                options: {
                    filterBy: [
                        "time_tracking_trackingId", "time_tracking_taskId", "time_tracking_userId", "time_tracking_startTime", "time_tracking_endTime", "time_tracking_duration", "time_tracking_status", "time_tracking_updatedBy", "time_tracking_updatedAt", "time_tracking_createdAt"
                    ],
                ...
                search: {
                permission: 'search_time_tracking',
                excludeSearch: ["image"],
                serverCommunication: serverCommunicationHelper({
                    parameters: parameters,
                    apiUrl: "",
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/time_tracking/view",
                      apiActionType: "hr_time_tracking_view",
                      requestType: "GET",
                      reduxActionType: "hr_time_tracking_view",
                  }),
                  options: {
                      pageSize: 10,

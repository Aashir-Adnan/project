            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/versions?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "versions_versionId", "versions_version", "versions_status", "versions_version", "versions_status", "versions_updatedBy", "versions_createdAt", "versions_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/versions/view",
                      apiActionType: "hr_versions_view",
                      requestType: "GET",
                      reduxActionType: "hr_versions_view",
                  }),
                  options: {
                      pageSize: 10,

            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/inventory?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "inventory_inventoryId", "inventory_departmentId", "inventory_currentCampusId", "inventory_previousCampusId", "inventory_inventoryName", "inventory_status", "inventory_updatedBy", "inventory_updatedAt", "inventory_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/inventory/view",
                      apiActionType: "hr_inventory_view",
                      requestType: "GET",
                      reduxActionType: "hr_inventory_view",
                  }),
                  options: {
                      pageSize: 10,

            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/roles?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "roles_roleId", "roles_roleName", "roles_status", "roles_roleName", "roles_status", "roles_seniorRoleId", "roles_updatedBy", "roles_createdAt", "roles_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/roles/view",
                      apiActionType: "hr_roles_view",
                      requestType: "GET",
                      reduxActionType: "hr_roles_view",
                  }),
                  options: {
                      pageSize: 10,

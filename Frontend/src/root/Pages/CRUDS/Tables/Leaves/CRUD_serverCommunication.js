            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/leaves?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "leaves_leaveId", "leaves_userId", "leaves_startDate", "leaves_endDate", "leaves_reason", "leaves_status", "leaves_updatedBy", "leaves_updatedAt", "leaves_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/leaves/view",
                      apiActionType: "hr_leaves_view",
                      requestType: "GET",
                      reduxActionType: "hr_leaves_view",
                  }),
                  options: {
                      pageSize: 10,

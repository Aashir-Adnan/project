            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/tasks?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "tasks_taskId", "tasks_taskTitle", "tasks_status", "tasks_taskTitle", "tasks_status", "tasks_type", "tasks_taskDescription", "tasks_parentTaskId", "tasks_attachementId", "tasks_taskFlowId", "tasks_taskAssignedToUserRoleDesignationDepartmentId", "tasks_createdByUserRoleDesignationDepartmentId", "tasks_updatedAt", "tasks_createdAt", "tasks_updatedBy"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/tasks/view",
                      apiActionType: "hr_tasks_view",
                      requestType: "GET",
                      reduxActionType: "hr_tasks_view",
                  }),
                  options: {
                      pageSize: 10,

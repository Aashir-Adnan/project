            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/attendance?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "attendance_attendanceId", "attendance_userId", "attendance_date", "attendance_checkInTime", "attendance_checkOutTime", "attendance_status", "attendance_updatedBy", "attendance_updatedAt", "attendance_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/attendance/view",
                      apiActionType: "hr_attendance_view",
                      requestType: "GET",
                      reduxActionType: "hr_attendance_view",
                  }),
                  options: {
                      pageSize: 10,

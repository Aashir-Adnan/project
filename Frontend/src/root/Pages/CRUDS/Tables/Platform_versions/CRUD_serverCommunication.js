            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/platform_versions?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "platform_versions_platformVersionId", "platform_versions_platformId", "platform_versions_versionId", "platform_versions_status", "platform_versions_platformId", "platform_versions_versionId", "platform_versions_status", "platform_versions_encryptionKey", "platform_versions_updatedBy", "platform_versions_createdAt", "platform_versions_updatedAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/platform_versions/view",
                      apiActionType: "hr_platform_versions_view",
                      requestType: "GET",
                      reduxActionType: "hr_platform_versions_view",
                  }),
                  options: {
                      pageSize: 10,

            ...
            features: {
                ...
                actions: [
                    ...
                    form: generateFormProps({
                        parameters: parameters,
                        apiUrl: "/grouped/cruds/teams?version=1.0",
                        requestType: "PUT",
                        mode:"edit"
                    }),
                    },
                ...
                options: {
                    filterBy: [
                        "teams_teamId", "teams_createdBy", "teams_name", "teams_status", "teams_updatedBy", "teams_updatedAt", "teams_createdAt"
                    ],
                ...
                pagination: {
                  ...
                  serverCommunication: serverCommunicationHelper({
                      parameters: parameters,
                      apiUrl: "/teams/view",
                      apiActionType: "hr_teams_view",
                      requestType: "GET",
                      reduxActionType: "hr_teams_view",
                  }),
                  options: {
                      pageSize: 10,
